...
def label_attack_step():
    ...
    step = {}
    step["benign"] = "benign"
    step["benigntraffic"] = "benign"
    step["ddos-tcp_flood"] = "action"
    step["ddos-icmp_flood"] = "action"
    step["ddos-syn_flood"] = "action"
    step["ddos-pshack_flood"] = "action"
    step["ddos-udp_flood"] = "action"
    step["dos-udp_flood"] = "action"
    step["ddos-ack_fragmentation"] = "action"
    step["ddos-synonymousip_flood"] = "action"
    step["ddos-rstfin_flood"] = "action"
    step["mirai-greeth_flood"] = "action"
    step["dos-tcp_flood"] = "action"
    step["dos-syn_flood"] = "action"
    step["mitm-arpspoofing"] = "infection"
    step["mirai-greip_flood"] = "action"
    step["ddos-icmp_fragmentation"] = "action"
    step["recon-osscan"] = "reconnaissance"
    step["ddos-udp_fragmentation"] = "action"
    step["recon-hostdiscovery"] = "reconnaissance"
    step["mirai-udpplain"] = "action"
    step["ddos-http_flood"] = "action"
    step["vulnerabilityscan"] = "reconnaissance"
    step["sqlinjection"] = "infection"
    step["dos-http_flood"] = "action"
    step["recon-portscan"] = "reconnaissance"
    step["dictionarybruteforce"] = "infection"
    step["dns_spoofing"] = "infection"
    step["ddos-slowloris"] = "action"
    step["xss"] = "infection"
    step["browserhijacking"] = "infection"
    step["uploading_attack"] = "infection"
    step["commandinjection"] = "infection"
    step["recon-pingsweep"] = "reconnaissance"
    step["backdoor_malware"] = "persistence"
...
def download(tdir):
    ...
    path = kagglehub.dataset_download("akashdogra/cic-iot-2023", force_download=True)
